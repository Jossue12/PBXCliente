...
/**
 * Test for transaction MACDT00001MXTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/MACDT00001MXTest.xml" })
public class MACDT00001MXTransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(MACDT00001MXTransactionTest.class);
	
	@Autowired
	private MACDT00001MXTransaction transaction;
